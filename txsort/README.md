...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/mraksoll4/btcutil/txsort)
...
```bash
$ go get -u github.com/mraksoll4/btcutil/txsort
```
